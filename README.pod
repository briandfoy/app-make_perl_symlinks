...
=head1 The App::make_perl_symlinks module

This is the I<README> for the L<App::make_perl_symlinks> Perl module.
...
and install the dependencies:
	...
	% cpan App::make_perl_symlinks
	% cpanm App::make_perl_symlinks
...
the source repository: L<https://github.com/briandfoy/app-make_perl_symlinks>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/app-make_perl_symlinks/issues>.
...
=item * L<https://bitbucket.com/briandfoy/app-make_perl_symlinks>

=item * L<https://codeberg.org/briandfoy/app-make_perl_symlinks>

=item * L<https://gitlab.com/briandfoy/app-make_perl_symlinks>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify App::make_perl_symlinks-1.23.tar.gz --owner briandfoy
